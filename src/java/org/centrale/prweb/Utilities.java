...
/**
 * Class Utilities Include static methods for the TP
 *
...
public class Utilities {
    ...
    /**
     * launchJSP method send a .jsp page
     *
     * @param request
     * @param response
    ...
    /**
     * getEmail method get the e-mail of the connected person
     *
     * @param request
    ...
    public static String getEmail(HttpServletRequest request) {
        ...
        if ((login != null) && (mdp != null)) {
            if ((login.equals("admin")) && (mdp.equals("admin"))) {
                email = "Connection en tant que administrateur ...";
            } else {
    ...
    /**
     * getMessageInFrame method Return the rest of the message to print in
     * iframe.jsp depending on the value
     *
     * @param request
     * @return
     */
